...
public class AllowanceController {
    ...
    public ResponseEntity<String> issueAllowance(@RequestBody AllowanceMainDto allowanceMainDto) throws Exception {
    ...
    public ResponseEntity<String> cancelAllowance(@RequestBody CanceledAllowanceDto cancelAllowanceMainDto) throws Exception {
